...
lazy val Hw5 = config("hw5") extend(Test)
...
def hw5Filter(name: String): Boolean = name endsWith "Testerhw5"
...
lazy val root = (project in file("."))
  ...
  .settings(
    ...
    libraryDependencies += scalatest % Hw5,
    ...
    testOptions in Hw5 := Seq(Tests.Filter(hw5Filter))
  )